...
rcParams["figure.figsize"] = (5.4 / 2.54, 5.4 / 2.54)
...
fig.savefig("losses_MLP_Trans.pdf", format='pdf')
...
fig.savefig("samples_MLP_Samples.pdf", format='pdf')
...
fig.savefig("samples_trans_best.pdf", format='pdf')
...
fig.savefig("samples_trans_worst.pdf", format='pdf')
...
fig.savefig("samples_trans_random.pdf", format='pdf')
