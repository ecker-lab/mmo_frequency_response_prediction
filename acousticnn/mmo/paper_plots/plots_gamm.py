...
plot.legend(["mean - Grid appr.","90 \% quant.", "mean - Query appr.", " 90 \% quant."], ncol = 1, prop = {'size': 6}, loc = 'upper left')
...
plot.legend(["Reference $x_2$","Reference $x_3$","Reference $x_4$","Prediction $x_2$","Prediction $x_3$","Prediction $x_4$"], prop = {'size': 6}, loc = 'lower left')
plt.tight_layout()
